...
const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    'dashboard.metrics.title': 'System metrics',
    'dashboard.metrics.health': 'Health',
    'dashboard.metrics.db': 'DB',
    'dashboard.metrics.uptime': 'Uptime (s)',
    'dashboard.metrics.requests': 'Requests',
    'dashboard.metrics.errors4xx': 'Errors 4xx',
    'dashboard.metrics.errors5xx': 'Errors 5xx',
    'dashboard.metrics.avg': 'Avg response (ms)',
  ...
  pt: {
    ...
    'dashboard.metrics.title': 'Métricas do sistema',
    'dashboard.metrics.health': 'Saúde',
    'dashboard.metrics.db': 'DB',
    'dashboard.metrics.uptime': 'Uptime (s)',
    'dashboard.metrics.requests': 'Requisições',
    'dashboard.metrics.errors4xx': 'Erros 4xx',
    'dashboard.metrics.errors5xx': 'Erros 5xx',
    'dashboard.metrics.avg': 'Média resposta (ms)',
  ...
  es: {
    ...
    'dashboard.metrics.title': 'Métricas del sistema',
    'dashboard.metrics.health': 'Salud',
    'dashboard.metrics.db': 'DB',
    'dashboard.metrics.uptime': 'Uptime (s)',
    'dashboard.metrics.requests': 'Solicitudes',
    'dashboard.metrics.errors4xx': 'Errores 4xx',
    'dashboard.metrics.errors5xx': 'Errores 5xx',
    'dashboard.metrics.avg': 'Promedio resp. (ms)',
